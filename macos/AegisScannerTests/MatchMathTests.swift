...
enum MatchMathTests {
    ...
    static func main() {
        ...
        ok(MatchMath.gallerySchema == 4, "gallery.json Schema 4")
        ...
        near(MatchMath.liveGhostHold, MatchMath.leftoverAdoptSec, 0.001, "Ghost-TTL = leftover 1,2 s")
        ...
        ok(!neigh.contains("1.2.4.4"), "Nachbar nicht Breite")
        ...
        ok(MatchMath.leftoverHoldLookup(hash: "1.3.4.4", table: holdTab, now: 10.5) == nil, "andere Breite kein Nachbar")
