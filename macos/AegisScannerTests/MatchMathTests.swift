...
enum MatchMathTests {
    ...
    static func main() {
        ...
        ok(MatchMath.leftoverBaptizeGate(raw: 0.82, smooth: 0.81, jpegDelta: 0.03, jpegRequired: true), "Gate required Gesicht")        ok(!MatchMath.leftoverTransfersId(cosine: 0.82, holdPrev: 0.80, jpegRequired: true), "Print ohne Probe keine Taufe")
