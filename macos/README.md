...
Familien-Bump nur auf dem Best-Paar, Live-Name 3-Tick-Mehrheit, Score-EMA, Gallery-Prune Cosine > 0,98 (schärfere Ref).

## Neu in 2.1.14 alpha

Box-Hysterese 2 Frames bei IoU < 0,35, Ingest-Duplikat Cosine > 0,95, Labor lässt unscharfe Gallery-Refs aus TAR.

## Neu in 2.1.13 alpha

Spark-Reset nach Reconnect, U-Slot-Vorschlag nach 1,2 s Maske (Snapshot, nicht der wackelige Tick), Print-Alter über `enrolledAt`, Labor ohne unscharfe TAR-Paare, `gallery.json.bak`.

## Neu in 2.1.12 alpha

Tile-Budget 2, Labor Maske/Voll, Ampel-Spark 8, Continuity-Floor 0,08, doch-Name, Orient ohne Live.
